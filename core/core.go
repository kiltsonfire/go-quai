...
func (c *Core) Append(header *types.Header, pendingHeader *types.Header, domTerminus common.Hash, td *big.Int, domOrigin bool, reorg bool) error {
	return c.sl.Append(header, pendingHeader, domTerminus, td, domOrigin, reorg)
}
...
func (c *Core) SubRelayPendingHeader(slPendingHeader types.PendingHeader, reorg bool, location common.Location) error {
	return c.sl.SubRelayPendingHeader(slPendingHeader, reorg, location)
}
