...
func (b *QuaiAPIBackend) Append(header *types.Header, domPendingHeader *types.Header, domTerminus common.Hash, domS *big.Int, domOrigin bool, reorg bool, newInboundEtxs types.Transactions) ([]types.Transactions, bool, error) {
...
func (b *QuaiAPIBackend) SubRelayPendingHeader(pendingHeader types.PendingHeader, s *big.Int, location common.Location, originCtx int) {
	b.eth.core.SubRelayPendingHeader(pendingHeader, s, location, originCtx)
}
