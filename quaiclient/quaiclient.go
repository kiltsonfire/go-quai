...
func (ec *Client) NewGenesisPendingHeader(ctx context.Context, header *types.WorkObject) error {
	return ec.c.CallContext(ctx, nil, "quai_newGenesisPendingHeader", header.RPCMarshalWorkObject())
}
