...
func RPCMarshalTdHeader(header *types.Header, pendingHeader *types.Header, domTerminus common.Hash, td *big.Int, domOrigin bool, reorg bool) (map[string]interface{}, error) {
	fields := map[string]interface{}{"header": RPCMarshalHeader(header)}
	fields["pendingHeader"] = RPCMarshalHeader(pendingHeader)
	fields["td"] = td
...
func (ec *Client) Append(ctx context.Context, header *types.Header, pendingHeader *types.Header, domTerminus common.Hash, td *big.Int, domOrigin bool, reorg bool) error {
	data, err := RPCMarshalTdHeader(header, pendingHeader, domTerminus, td, domOrigin, reorg)
	if err != nil {
		return err
	}
...
func (ec *Client) SubRelayPendingHeader(ctx context.Context, pendingHeader types.PendingHeader, reorg bool, location common.Location) error {
