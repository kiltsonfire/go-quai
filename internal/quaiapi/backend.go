...
type Backend interface {
	...
	Append(header *types.Header, pendingHeader *types.Header, domTerminus common.Hash, td *big.Int, domOrigin bool, reorg bool) error
	...
	SubRelayPendingHeader(pendingHeader types.PendingHeader, reorg bool, location common.Location) error
